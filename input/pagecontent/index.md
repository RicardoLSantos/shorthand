...
| **Example instances** | 193 | every concrete profile has a standalone example (103 of 103 in the v0.5.2 build — 102 of 102 in v0.5.1; `ConsumerECGObservation`, the abstract ECG parent, is excluded from the denominator — the figure is read from the build's examples pages) |
