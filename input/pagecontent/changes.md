...
- **Built with IG Publisher 2.3.4 and SUSHI 3.20.1** (0.5.1: 2.2.10 and 3.18.1). 2.3.4 is the version the CI already runs, so the release build and the CI now use the same publisher.
