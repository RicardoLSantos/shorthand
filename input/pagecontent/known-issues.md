...
- **Narrative pages carry codes and one figure that a review found wrong** (at least 18 codes quoted only in page text, and an "86 % terminology gap" figure on five pages); they are listed in the 0.5.1 change log and corrected in 0.5.2. No resource of the release and no ledger row is affected.
