...
| `wearable_device` | CLUSTER | **specialisation** of `CLUSTER.device.v1` | 0 (cluster) |
| `data_quality_indicator` | CLUSTER | none | 0 (cluster, by design) |
| `vendor_data_provenance` | CLUSTER | none | 0 (cluster, by design) |

> **State of the binding column: 7 of the 12 carry an external binding · 18 bindings in total.** Measured directly in the ADL source on 2026-07-15, and validated with Archie 3.15.0: 12/12 `OK | VALID | 0 errors | 0 warnings`.
