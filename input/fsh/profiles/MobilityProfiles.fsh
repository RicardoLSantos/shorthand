...
// Six-Minute Walk Test Distance (iOS 14+)
* component[sixMinuteWalkDistance].code = $LIFESTYLEOBS#six-minute-walk-distance "Six-minute walk test distance"
...
* $LIFESTYLEOBS#six-minute-walk-distance "Six-minute walk test distance"
