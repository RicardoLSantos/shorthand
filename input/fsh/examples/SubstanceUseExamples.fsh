...
* component[packYears].code = $LOINC#8663-7 "Cigarette pack-years"
...
* component[cigarettesPerDay].code = $LOINC#64218-1 "How many cigarettes do you smoke per day"
...
* component[tobaccoType].code = $LOINC#81229-7 "Tobacco product"
...
* subject = Reference(Patient/PatientExample)
* effectiveDateTime = "2025-11-25T10:00:00Z"
* valueCodeableConcept = $SCT#266919005 "Never smoked tobacco"
...
* subject = Reference(Patient/PatientExample)
* effectiveDateTime = "2025-11-25T10:00:00Z"
* valueCodeableConcept = $SCT#228278007 "Moderate drinker"
* component[drinksPerWeek].code = $LOINC#68518-0 "How many standard drinks containing alcohol do you have on a typical day"
* component[drinksPerWeek].valueQuantity = 7 '/wk' "per week"
* component[drinkingFrequency].code = $LOINC#68519-8 "How often do you have a drink containing alcohol"
* component[drinkingFrequency].valueCodeableConcept = AlcoholDrinkingFrequencyCS#2-3-per-week "2-3 times per week"
* component[auditCScore].code = $LOINC#75626-2 "AUDIT-C Total score"
...
* subject = Reference(Patient/PatientExample)
* effectiveDateTime = "2025-11-25T10:00:00Z"
* valueCodeableConcept = $SCT#105542008 "Non-drinker of alcohol"
* component[drinkingFrequency].code = $LOINC#68519-8 "How often do you have a drink containing alcohol"
...
* subject = Reference(Patient/PatientExample)
* effectiveDateTime = "2025-11-25T10:00:00Z"
* valueCodeableConcept = $SCT#228279004 "Heavy drinker"
* component[drinksPerWeek].code = $LOINC#68518-0 "How many standard drinks containing alcohol do you have on a typical day"
...
* component[bingeEpisodes].code = $LOINC#68520-6 "Binge drinking episodes per month"
...
* component[tobaccoStatus].valueCodeableConcept = $SCT#8517006 "Ex-smoker"
* component[alcoholStatus].code = $LOINC#11367-0 "History of alcohol use"
* component[alcoholStatus].valueCodeableConcept = $SCT#228278007 "Moderate drinker"
* component[caffeineStatus].code = $LOINC#89574-8 "Caffeine intake"
