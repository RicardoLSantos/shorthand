...
* code = $LOINC#balance-score "Balance assessment score"
* component contains
...
* component[balanceStatus]
  * code = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/lifestyle-observation-cs#balance-assessment "Balance assessment"
...
* component[distance]
  * code = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/lifestyle-observation-cs#movement-assessment "Walking distance"
  * valueQuantity.system = $UCUM
