...
* extension[=].extension[=].valueCodeableConcept = AppLogicCS#gdpr "GDPR - General Data Protection Regulation"
...
* extension[=].valueCodeableConcept = AppLogicCS#gdpr "GDPR - General Data Protection Regulation"
