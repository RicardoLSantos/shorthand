...
* status = #completed
* intent = #proposal
* code = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#review-trend "Review Trend"
...
* businessStatus = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#approved "Approved"
* statusReason = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#clinician-approved "Clinician Approved"
...
* reasonCode = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#concerning-trend "Concerning Trend"
...
* extension[agentRecommendation].extension[interpretation].valueCodeableConcept = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#agent-interpretation-schedule-followup "Schedule Follow-up"
...
* extension[evidenceQuality].extension[dataCompleteness].valueCodeableConcept = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#mostly-complete "Mostly Complete"
...
* extension[actionStatus].extension[actionCode].valueCodeableConcept = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#agent-interpretation-schedule-followup "Schedule Follow-up"
...
* extension[agentRecommendation].extension[interpretation].valueCodeableConcept = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#escalate-clinician "Escalate to Clinician"
...
// Agent Evidence Quality extension
* extension[evidenceQuality].extension[dataCompleteness].valueCodeableConcept = https://2rdoc.pt/ig/ios-lifestyle-medicine/CodeSystem/agent-decision-support-cs#agent-completeness-complete "Complete"
