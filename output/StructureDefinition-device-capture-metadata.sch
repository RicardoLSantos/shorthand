...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'samplingRate']) &lt;= 1">extension with URL = 'samplingRate': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'sensorType']) &lt;= 1">extension with URL = 'sensorType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'captureMethod']) &lt;= 1">extension with URL = 'captureMethod': maximum cardinality of 'extension' is 1</sch:assert>
