...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'mapping']) &gt;= 1">extension with URL = 'mapping': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'mapping']) &lt;= 1">extension with URL = 'mapping': maximum cardinality of 'extension' is 1</sch:assert>
