...
- **Artefact counts at 0.5.1**: 103 profiles / 77 extensions / 19 CodeSystems / **206** ValueSets (two added today: `MenstrualCycleRegularityVS`, `SleepHRVMetricVS`) / 279 instances = **684** artefacts, counted from the FSH sources by `ig_counts.sh` (the 682 quoted above is the 0.5.0 figure the README carried until this release).
