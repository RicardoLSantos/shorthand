...
### Examples
- Weight measurements use the [body-weight](StructureDefinition-observation-vital-signs-weight.html) profile
- Height uses the [body-height](StructureDefinition-observation-vital-signs-height.html) profile
- BMI calculations use the [bmi](StructureDefinition-observation-vital-signs-bmi.html) profile
